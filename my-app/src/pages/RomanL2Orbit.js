  ...
  return (
    <group ref={ref}>
      ...
      <mesh>
        ...
        <meshBasicMaterial color="#ff922b" transparent opacity={0.2} blending={THREE.AdditiveBlending} depthWrite={false} />
      </mesh>
    </group>
  );
}

export default function RomanL2Orbit() {
    ...
    <div style={{ position: "relative", width: "100%", height: "450px", background: "#06070a", borderRadius: "16px", overflow: "hidden", border: "1px solid var(--border)", margin: "40px 0" }}>
      ...
      <div style={{ position: "absolute", top: 20, left: 20, zIndex: 10, color: "#fff", fontSize: "13px", fontFamily: "var(--font-mono)", display: "flex", flexDirection: "column", gap: 12 }}>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span>{t("roman.l2.diagram_earth", "Earth")}</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 10, height: 10, borderRadius: "50%", background: "#ff922b" }} />
          <span>Roman Space Telescope</span>
        </div>
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
          ...
          <span>{t("roman.l2.diagram_sun", "Sun")} direction &larr;</span>
        </div>
      </div>
